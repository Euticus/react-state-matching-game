...
class App extends Component{
  ...
  handleTileClicked = (id, color) => {
    this.setState((prevState)=>{
      ...
      let toBeCleared = prevState.toBeCleared
      const selectedTileIndex = indexOfSelected(tiles, id, color)
      let previousTileIndex = prevState.previousTileIndex
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <Board numTiles={this.state.numTiles} tiles={this.state.tiles} handleTileClicked={this.handleTileClicked} /> 
    </div>
  );
